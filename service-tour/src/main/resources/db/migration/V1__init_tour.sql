...
('Du lịch biển', 'Các tour nghỉ dưỡng biển'),
('Leo núi', 'Tour leo núi');

-- Insert initial locations
INSERT INTO locations (name, country, province, description) VALUES
('Phú Quốc', 'Việt Nam', 'Kiên Giang', 'Đảo ngọc'),
('Sa Pa', 'Việt Nam', 'Lào Cai', 'Thị trấn mây');

-- Insert initial tours
INSERT INTO tours (name, description, category_id, location_id, duration_days, max_people, available_slots, price, status) VALUES
